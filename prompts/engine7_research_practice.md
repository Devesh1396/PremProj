...
```
RUNTIME_INPUT_CONTRACT CLIENT_NEW E7/CASE = CASE_VERSION, CANONICAL_STATE, CASE_RESEARCH_QUESTIONS, E1_PASS_A_HANDOFF, NORMALIZED_CONCEPTS, PRACTICE_EXPERIENCE, RETRIEVED_KNOWLEDGE
```
