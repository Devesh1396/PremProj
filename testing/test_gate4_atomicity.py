...
def main() -> int:
    ...
    check("the complete import landed", s["objects"] == 11 and s["blocks"] == 61,
          str(s))
    # 11 OBJECT fields since 050: the 11 object bodies and nothing else.
    # 049 had briefly added a 12th -- `Decision intelligence` stored as
    # client_decision_logic -- which 050 withdrew because in a curated
    # object that label means prognosis, not selection. (A 13th field belongs to
